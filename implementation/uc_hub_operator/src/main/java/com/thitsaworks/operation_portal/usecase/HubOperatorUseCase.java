...
public abstract class HubOperatorUseCase<I, O> extends DomainUseCase<I, O> {

    private static final Logger LOGGER = LoggerFactory.getLogger(HubOperatorUseCase.class);

    private final Set<UserRoleType> PERMITTED_ROLES;

    private final PrincipalCache principalCache;

    public HubOperatorUseCase(Set<UserRoleType> permittedRoles,
