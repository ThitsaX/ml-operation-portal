...
public abstract class ParticipantUseCase<I, O> extends DomainUseCase<I, O> {

    private static final Logger LOGGER = LoggerFactory.getLogger(ParticipantUseCase.class);

    private final Set<UserRoleType> PERMITTED_ROLES;

    private final PrincipalCache principalCache;

    protected ParticipantUseCase(Set<UserRoleType> permittedRoles, PrincipalCache principalCache) {
