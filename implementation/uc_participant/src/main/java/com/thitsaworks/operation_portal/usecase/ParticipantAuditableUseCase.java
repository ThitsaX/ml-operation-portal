...
public abstract class ParticipantAuditableUseCase<I,O> extends DomainUseCase<I,O> {
    private static final Logger LOGGER= LoggerFactory.getLogger(ParticipantAuditableUseCase.class);
    ...
    public ParticipantAuditableUseCase(CreateInputAuditCommand createInputAuditCommand,
                                       CreateOutputAuditCommand createOutputAuditCommand,
                                       CreateExceptionAuditCommand createExceptionAuditCommand,
                                       Set<UserRoleType> PERMITTED_ROLES,
    ...
    protected void afterExecute(O output) throws DomainException {
        ...
        var auditId = ParticipantAuditableUseCase.auditId.get();
    ...
    protected void beforeExecute(I input) throws DomainException {
        ...
        ParticipantAuditableUseCase.auditId.set(this.createInputAuditCommand.execute(new CreateInputAuditCommand.Input(this.getName(),
                                                                                                                  new UserId(
                                                                                                                      principalId.getId()),
