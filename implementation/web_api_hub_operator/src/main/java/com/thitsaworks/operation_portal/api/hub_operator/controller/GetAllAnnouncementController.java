...
public class GetAllAnnouncementController {
    ...
    @GetMapping(value = "/public/get_all_announcement")
    public ResponseEntity<Response> execute() throws DomainException, JsonProcessingException {
        ...
        LOG.info("Get all announcement response: {}", objectMapper.writeValueAsString(response));
    ...
    public record Response(
            @JsonProperty("announcement_info_list") List<AnnouncementInfo> announcementInfoList)
