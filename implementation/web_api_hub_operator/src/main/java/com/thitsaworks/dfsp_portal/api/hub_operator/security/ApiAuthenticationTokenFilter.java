...
import com.thitsaworks.dfsp_portal.api.hub_operator.security.exception.AccessDeniedException;
import com.thitsaworks.dfsp_portal.api.hub_operator.security.exception.ApiSecurityException;
        ...
        if ((authHeader == null || authHeader.isEmpty()) || (accessKey == null || accessKey.isEmpty())) {
            ...
            if (SecurityContextHolder.getContext().getAuthentication() == null) {
                ...
                try {
                    ...
                    authorities.add(new SimpleGrantedAuthority("ROLE_HUB_OPERATOR"));

                    UsernamePasswordAuthenticationToken authenticationToken =
                            new UsernamePasswordAuthenticationToken(uc.getHubUserId(), "N.A", authorities);

                    authenticationToken.setDetails(uc);

                    UseCaseContext.set(uc);
                    UseCaseContext.set(new SecurityContext(uc.getHubUserId().getId().toString(),
