package com.thitsaworks.dfsp_portal.api.participant;

import com.thitsaworks.dfsp_portal.api.participant.security.ApiAuthenticationEntryPoint;
import com.thitsaworks.dfsp_portal.api.participant.security.ApiAuthenticationTokenFilter;
import com.thitsaworks.dfsp_portal.api.participant.security.ApiAuthenticator;
import com.thitsaworks.dfsp_portal.api.participant.security.AuthFilterExceptionHandler;
import com.thitsaworks.dfsp_portal.api.participant.security.Authenticator;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.csrf().disable().sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS).and()
                    ...
                    .hasRole("PARTICIPANT").anyRequest().authenticated();
        // @@formatter:on
