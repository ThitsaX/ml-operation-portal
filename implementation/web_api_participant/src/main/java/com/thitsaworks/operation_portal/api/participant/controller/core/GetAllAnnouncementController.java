...
public class GetAllAnnouncementController {
    ...
    public ResponseEntity<Response> execute() throws OperationPortalException, JsonProcessingException {
        ...
        var response = new Response(announcementInfoList);

        LOG.info("Get all announcement response : {}", this.objectMapper.writeValueAsString(response));
    ...
    public record Response(@JsonProperty("announcement_info_list") List<AnnouncementInfo> announcementInfoList) {
        ...
        public record AnnouncementInfo(
                ...
                @JsonProperty("date") String announcementDate
        ) {}
