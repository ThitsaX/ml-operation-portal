...
import com.thitsaworks.operation_portal.usecase.hub_services.GetAllIDType;
...
public class GetAllIDTypeController {
    ...
    public ResponseEntity<Response> execute() throws DomainException, JsonProcessingException {
        ...
        LOG.info("Get all party identifier type  request : {}", "");
        ...
        LOG.info("Get all party identifier type response : {}", this.objectMapper.writeValueAsString(response));
