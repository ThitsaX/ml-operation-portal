...
public abstract class CoreServicesAuditableUseCase<I, O> extends DomainUseCase<I, O> {

    private static final Logger LOGGER = LoggerFactory.getLogger(CoreServicesAuditableUseCase.class);
    ...
    public CoreServicesAuditableUseCase(CreateInputAuditCommand createInputAuditCommand,
    ...
    protected void afterExecute(O output) throws DomainException {
        ...
        var auditId = CoreServicesAuditableUseCase.auditId.get();
    ...
    protected void beforeExecute(I input) throws DomainException {
        ...
        CoreServicesAuditableUseCase.auditId.set(this.createInputAuditCommand.execute(new CreateInputAuditCommand.Input(this.getName(),
                                                                                                                        new UserId(
                                                                                                                      principalId.getId()),
