package com.thitsaworks.operation_portal.component.spring;
...
public class DefaultSpringRestErrorResponseBuilder
    ...
    public SpringRestServiceExceptionHandler.SpringRestErrorResponse build(Exception exception) {
        ...
        if ((exception instanceof MethodArgumentNotValidException)) {
            ...
            return new SpringRestServiceExceptionHandler.SpringRestErrorResponse(DFSPPortalException.errorCode(),
