...
public class OnboardUserController {

    private static final Logger LOG = LoggerFactory.getLogger(OnboardUserController.class);

    private final OnboardUser onboardUser;
    ...
    public ResponseEntity<Response> execute(@Valid @RequestBody Request request)
        ...
        OnboardUser.Output output = this.onboardUser.execute(
                new OnboardUser.Input(request.name,
