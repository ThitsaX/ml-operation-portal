...
public abstract class CentralLedgerUseCase<I, O> extends DomainUseCase<I, O> {

    private static final Logger LOGGER = LoggerFactory.getLogger(CentralLedgerUseCase.class);

    private final Set<UserRoleType> PERMITTED_ROLES;

    private final PrincipalCache principalCache;

    public CentralLedgerUseCase(Set<UserRoleType> permittedRoles,
