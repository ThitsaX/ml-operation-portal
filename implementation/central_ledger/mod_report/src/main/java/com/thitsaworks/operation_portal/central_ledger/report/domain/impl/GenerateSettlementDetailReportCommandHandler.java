package com.thitsaworks.operation_portal.central_ledger.report.domain.impl;
...
public class GenerateSettlementDetailReportCommandHandler implements GenerateSettlementDetailReportCommand {
    ...
    public GenerateSettlementDetailReportCommandHandler(@Qualifier(PersistenceQualifiers.central_ledger.JDBC_TEMPLATE) JdbcTemplate jdbcTemplate) {
    ...
    public Output execute(Input input) throws Exception {
        ...
        InputStream detailReport = this.getClass().getResourceAsStream(
                "/com/thitsaworks/operation_portal/central_ledger/report/report/dfspSettlementDetailReport.jasper");
