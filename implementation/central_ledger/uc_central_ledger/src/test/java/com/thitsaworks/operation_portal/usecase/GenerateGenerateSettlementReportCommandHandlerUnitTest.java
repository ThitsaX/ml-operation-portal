...
public class GenerateGenerateSettlementReportCommandHandlerUnitTest extends EnvAwareUnitTest {

    private static final Logger LOG = LoggerFactory.getLogger(GenerateGenerateSettlementReportCommandHandlerUnitTest.class);
