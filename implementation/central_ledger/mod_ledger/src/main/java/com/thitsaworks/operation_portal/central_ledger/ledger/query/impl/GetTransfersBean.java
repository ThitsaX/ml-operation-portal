package com.thitsaworks.operation_portal.central_ledger.ledger.query.impl;

import com.thitsaworks.operation_portal.central_ledger.ledger.data.mapper.TransferDataMapper;
import com.thitsaworks.operation_portal.central_ledger.ledger.query.GetTransfers;
...
@Service
public class GetTransfersBean implements GetTransfers {

    private static final Logger LOG = LoggerFactory.getLogger(GetTransfersBean.class);
