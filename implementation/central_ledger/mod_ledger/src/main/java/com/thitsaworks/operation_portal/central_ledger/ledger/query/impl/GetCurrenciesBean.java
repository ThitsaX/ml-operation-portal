...
import com.thitsaworks.operation_portal.central_ledger.ledger.data.mapper.CurrencyDataMapper;
...
public class GetCurrenciesBean implements GetCurrencies {
    ...
    public GetCurrenciesBean(@Qualifier(PersistenceQualifiers.central_ledger.JDBC_TEMPLATE) JdbcTemplate jdbcTemplate) {
