...
public class SettlementDetailReport {

    @Autowired
    private JdbcTemplate centralLedgerJdbcTemplate;


    public byte[] generate(String settlementId, String fspId, String fileType,String timezone)
            throws JRException, IOException, SQLException {

        Map<String, Object> params = new HashMap<String, Object>();

        params.put("settlementId", settlementId);
        params.put("fspId", fspId);
        params.put("timezoneoffset",timezone);

        InputStream detailReport = this.getClass().getResourceAsStream(
                "/com/thitsa/dfsp_portal/report/report/dfspSettlementDetailReport.jasper");
