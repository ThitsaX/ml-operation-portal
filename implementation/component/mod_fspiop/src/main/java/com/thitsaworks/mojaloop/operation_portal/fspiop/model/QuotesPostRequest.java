...
import com.thitsaworks.mojaloop.operation_portal.fspiop.model.AmountType;
import com.thitsaworks.mojaloop.operation_portal.fspiop.model.CurrencyConverter;
...
import com.thitsaworks.mojaloop.operation_portal.fspiop.model.Party;
import com.thitsaworks.mojaloop.operation_portal.fspiop.model.QuotesPostRequestCurrencyConversion;
import com.thitsaworks.mojaloop.operation_portal.fspiop.model.TransactionType;
...
public class QuotesPostRequest   {
 ...
 @Pattern(regexp="^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$")  public String getTransactionRequestId() {
  ...
  /**
   **/
  public QuotesPostRequest currencyConversion(QuotesPostRequestCurrencyConversion currencyConversion) {
