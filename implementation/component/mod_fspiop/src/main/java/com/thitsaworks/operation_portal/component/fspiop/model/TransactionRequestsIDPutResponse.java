...
import com.thitsaworks.operation_portal.component.fspiop.model.TransactionRequestState;
...
public class TransactionRequestsIDPutResponse   {
  ...
  private @Valid TransactionRequestState transactionRequestState;
 ...
 @Pattern(regexp="^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$")  public String getTransactionId() {
  ...
  @JsonProperty("transactionRequestState")
  @NotNull
