...
import com.thitsaworks.operation_portal.component.fspiop.model.IndividualQuoteResult;
...
public class BulkQuotesIDPutResponse   {
   ...
   **/
  public BulkQuotesIDPutResponse individualQuoteResults(List<IndividualQuoteResult> individualQuoteResults) {
 ...
 @Size(max=1000)  public List<IndividualQuoteResult> getIndividualQuoteResults() {
