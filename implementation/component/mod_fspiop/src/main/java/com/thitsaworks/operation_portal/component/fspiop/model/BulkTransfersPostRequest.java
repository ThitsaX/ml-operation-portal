...
import com.thitsaworks.operation_portal.component.fspiop.model.IndividualTransfer;
...
public class BulkTransfersPostRequest   {
  private @Valid String bulkTransferId;
  private @Valid String bulkQuoteId;
  private @Valid String payerFsp;
  private @Valid String payeeFsp;
  private @Valid List<IndividualTransfer> individualTransfers = new ArrayList<>();
  ...
  @JsonProperty("bulkTransferId")
  @NotNull
 @Pattern(regexp="^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$")  public String getBulkTransferId() {
  ...
  @JsonProperty("bulkQuoteId")
  @NotNull
 @Pattern(regexp="^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$")  public String getBulkQuoteId() {
    return bulkQuoteId;
  }
 ...
 @Size(min=1,max=32)  public String getPayeeFsp() {
  ...
  @JsonProperty("individualTransfers")
  @NotNull
 @Size(min=1,max=1000)  public List<IndividualTransfer> getIndividualTransfers() {
