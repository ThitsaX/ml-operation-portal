...
INSERT INTO tbl_role (role_id, name, active, created_date, updated_date) VALUES
    (1, 'HUB-Admin', 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
    (2, 'HUB-Manager', 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
    (3, 'HUB-Operator', 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
    (4, 'HUB-User', 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
    (5, 'DFSP-Admin', 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
    (6, 'DFSP-Operation', 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP())
AS new_roles
...
INSERT INTO tbl_action (action_id, action_code, scope, description, created_date, updated_date) VALUES
    (1, 'GrantRoleActions', 'OPERATION_PORTAL', 'Auto-registered action for use case: GrantRoleActions', UNIX_TIMESTAMP(), UNIX_TIMESTAMP())
AS new_actions
ON DUPLICATE KEY UPDATE
