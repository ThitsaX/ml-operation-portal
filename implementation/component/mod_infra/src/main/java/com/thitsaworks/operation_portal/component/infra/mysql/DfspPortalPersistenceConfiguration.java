...
@EnableJpaRepositories(
    basePackages = "com.thitsaworks.operation_portal.dfsp_portal.*",
...
public class DfspPortalPersistenceConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        entityManagerFactoryBean.setPackagesToScan("com.thitsaworks.operation_portal.dfsp_portal.**");
