...
public class RemoveAnnouncementsHandler implements RemoveAnnouncements {

    private static final Logger LOG = LoggerFactory.getLogger(RemoveAnnouncementsHandler.class);
