...
public class ReportErrors {
    ...
    public static final ErrorMessage REPORT_MAXIMUM_LIMIT_EXCEPTION = new ErrorMessage("REPORT_MAXIMUM_LIMIT_EXCEPTION", "The report row count [{0}] exceeds the maximum allowed limit of [{1}] rows.");
