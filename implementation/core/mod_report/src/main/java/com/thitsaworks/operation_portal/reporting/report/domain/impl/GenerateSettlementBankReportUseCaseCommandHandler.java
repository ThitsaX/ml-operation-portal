...
@Service
public class GenerateSettlementBankReportUseCaseCommandHandler
    implements GenerateSettlementBankReportUseCaseCommand {

    private static final Logger LOG = LoggerFactory.getLogger(
        GenerateSettlementBankReportUseCaseCommandHandler.class);

    private final JdbcTemplate jdbcTemplate;

    public GenerateSettlementBankReportUseCaseCommandHandler(
    ...
    public Output execute(Input input) throws ReportException {
        ...
        InputStream jrxmlStream = getClass()
                                      .getClassLoader()
                                      .getResourceAsStream(
                                          "com/thitsaworks/operation_portal/reporting/report/report/settlementBankReport_UseCase.jrxml");
        ...
        try (Connection conn = this.jdbcTemplate.getDataSource().getConnection()) {
            ...
            design.setName("settlementBankReportUseCase");

            // Hide page footer when exporting Excel.
            ...
            } else if ("pdf".equalsIgnoreCase(input.fileType())) {
            ...
            } else if ("csv".equalsIgnoreCase(input.fileType())) {
