...
public class SettlementErrors {
    ...
    public static final ErrorMessage WINDOW_CLOSING_METHOD_MISSING = new ErrorMessage("WINDOW_CLOSING_METHOD_MISSING", "Settlement model : [{0}] should specify at least one window-closing method (Manual or Auto).");
    //@@formatter:on
}
