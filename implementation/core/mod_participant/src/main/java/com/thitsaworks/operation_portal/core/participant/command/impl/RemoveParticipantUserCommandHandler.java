...
public class RemoveParticipantUserCommandHandler implements RemoveParticipantUserCommand {

    private static final Logger LOG = LoggerFactory.getLogger(RemoveParticipantUserCommandHandler.class);
    ...
    public RemoveParticipantUserCommand.Output execute(RemoveParticipantUserCommand.Input input)
        ...
        return new RemoveParticipantUserCommand.Output(input.participantUserId(), true);
    }
