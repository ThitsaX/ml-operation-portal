...
public class FindAccountNumberByDfspCodeJpaQueryHandler implements FindAccountNumberByDfspCodeQuery {

    private static final Logger LOG = LoggerFactory.getLogger(FindAccountNumberByDfspCodeJpaQueryHandler.class);
    ...
    public Output execute(Input input) {
        ...
        return new FindAccountNumberByDfspCodeQuery.Output(
