...
public class ModifyParticipantCompanyShortNameCommandHandler implements ModifyParticipantCompanyShortNameCommand {

    private static final Logger LOG = LoggerFactory.getLogger(ModifyParticipantCompanyShortNameCommandHandler.class);
