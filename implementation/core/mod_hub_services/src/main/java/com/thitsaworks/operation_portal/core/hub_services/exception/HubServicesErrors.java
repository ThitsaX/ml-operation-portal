...
public class HubServicesErrors {
    ...
    public static final ErrorMessage HUB_PARTICIPANT_NOT_FOUND = new ErrorMessage("HUB_PARTICIPANT_NOT_FOUND", "System cannot find the participant with provided participantName on Hub.");
