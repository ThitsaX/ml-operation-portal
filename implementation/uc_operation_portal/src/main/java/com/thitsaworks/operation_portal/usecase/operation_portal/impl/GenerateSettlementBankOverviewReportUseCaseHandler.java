...
@Service
public class GenerateSettlementBankOverviewReportUseCaseHandler
        extends OperationPortalAuditableUseCase<GenerateSettlementBankOverviewReportUseCase.Input, GenerateSettlementBankOverviewReportUseCase.Output>
        implements GenerateSettlementBankOverviewReportUseCase {

    private static final Logger LOG = LoggerFactory.getLogger(GenerateSettlementBankOverviewReportUseCaseHandler.class);
    ...
    public GenerateSettlementBankOverviewReportUseCaseHandler(CreateInputAuditCommand createInputAuditCommand,
