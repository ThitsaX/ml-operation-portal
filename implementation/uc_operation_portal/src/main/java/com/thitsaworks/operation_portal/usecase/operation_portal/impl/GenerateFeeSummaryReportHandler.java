...
public class GenerateFeeSummaryReportHandler
    ...
    protected Output onExecute(Input input) throws DomainException {
        ...
        ReportDownloadRequestManager.CreateOrReuseResult
            result =
            this.reportDownloadRequestManager.createPendingOrReuse(
                ReportType.FEE_SUMMARY, normalizedFileType, params);
        ...
        if (FileDownloadStatus.READY.equals(result.request()
                                                  .status()) && fileKey != null &&
                !fileKey.isBlank()) {
        ...
        if (FileDownloadStatus.FAILED.equals(result.request()
                                                   .status())) {
