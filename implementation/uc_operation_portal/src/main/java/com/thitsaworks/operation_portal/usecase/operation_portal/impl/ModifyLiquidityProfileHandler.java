...
public class ModifyLiquidityProfileHandler
    ...
    protected Output onExecute(Input input) throws DomainException {
        ...
        var output = this.modifyLiquidityProfileCommand.execute(
            new ModifyLiquidityProfileCommand.Input(
                input.participantId(), input.liquidityProfileId(), input.bankName(),
                input.accountName(), input.accountNumber(), input.currency()));
