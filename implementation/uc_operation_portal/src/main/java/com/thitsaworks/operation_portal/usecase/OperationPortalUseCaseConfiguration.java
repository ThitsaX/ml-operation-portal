...
@Import(
    value = {
        ...
        HubServicesConfiguration.class, HubUserConfiguration.class, ApprovalConfiguration.class, ReportConfiguration.class,
        IAMTestConfiguration.class , SchedulerConfiguration.class
    })
