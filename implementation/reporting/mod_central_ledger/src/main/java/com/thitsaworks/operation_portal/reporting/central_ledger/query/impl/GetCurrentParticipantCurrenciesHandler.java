...
@Service
public class GetCurrentParticipantCurrenciesHandler implements GetCurrentParticipantCurrencies {

    private static final Logger LOG = LoggerFactory.getLogger(GetCurrentParticipantCurrenciesHandler.class);

    private final JdbcTemplate jdbcTemplate;

    @Autowired
    public GetCurrentParticipantCurrenciesHandler(@Qualifier(PersistenceQualifiers.Reporting.READ_JDBC_TEMPLATE) JdbcTemplate jdbcTemplate) {
