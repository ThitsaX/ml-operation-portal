...
@Service
public class GetFinancialDataHandler implements GetFinancialData {

    private static final Logger LOG = LoggerFactory.getLogger(GetFinancialDataHandler.class);

    private final JdbcTemplate jdbcTemplate;

    @Autowired
    public GetFinancialDataHandler(@Qualifier(PersistenceQualifiers.Reporting.READ_JDBC_TEMPLATE) JdbcTemplate jdbcTemplate) {
