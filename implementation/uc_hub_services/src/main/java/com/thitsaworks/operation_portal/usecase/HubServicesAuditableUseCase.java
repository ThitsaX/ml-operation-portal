...
public abstract class HubServicesAuditableUseCase<I, O> extends DomainUseCase<I, O> {

    private static final Logger LOGGER = LoggerFactory.getLogger(HubServicesAuditableUseCase.class);
    ...
    public HubServicesAuditableUseCase(CreateInputAuditCommand createInputAuditCommand,
    ...
    protected void afterExecute(O output) throws DomainException {
        ...
        var auditId = HubServicesAuditableUseCase.auditId.get();
    ...
    protected void beforeExecute(I input) throws DomainException {
        ...
        HubServicesAuditableUseCase.auditId.set(this.createInputAuditCommand.execute(new CreateInputAuditCommand.Input(
                                                          this.getName(),
                                                          new UserId(
                                                              principalId.getId()),
