...
public abstract class HubServicesUseCase<I, O> extends DomainUseCase<I, O> {

    private static final Logger LOGGER = LoggerFactory.getLogger(HubServicesUseCase.class);

    private final Set<UserRoleType> PERMITTED_ROLES;

    private final PrincipalCache principalCache;

    public HubServicesUseCase(Set<UserRoleType> permittedRoles,
