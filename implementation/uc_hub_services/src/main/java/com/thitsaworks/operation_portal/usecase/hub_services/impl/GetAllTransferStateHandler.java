...
import com.thitsaworks.operation_portal.usecase.hub_services.GetAllTransferState;
...
public class GetAllTransferStateHandler
    extends HubServicesUseCase<GetAllTransferState.Input, GetAllTransferState.Output> implements GetAllTransferState {
